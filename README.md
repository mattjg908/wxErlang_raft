...
wxErlang re-implementation of raftscope as seen on [raft.github.io](https://raft.github.io/)
...
* Note: the first post-election `AppendEntries` you see may be an empty heartbeat *or* the no-op replication,
  depending on scheduling/timers in the simulator. Both orderings are fine.
